angular.module('lazHack6')
    ...
    .controller("whiteboardController", function(Images, whiteboard){
        var ctrl = this;
        var canvas;
        var ctx;
        var isDrawing = false;
        ...
        ctrl.$onInit = function(){
            ...
            whiteboard.ref.on("child_added", function(child){
        ...
        function recordDrawEvent(e){
            if(!isDrawing) return;
            whiteboard.recordDrawEvent(e, ctrl.savedLineWidth, ctrl.selectedColor, ctrl.postItMode);
        }
